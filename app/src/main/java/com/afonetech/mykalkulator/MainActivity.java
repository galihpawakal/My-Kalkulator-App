package com.afonetech.mykalkulator;
        ...
        btn_hitung.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(etNilaia.getText().toString().isEmpty()){
                    Toast.makeText(MainActivity.this, "Nilai A nya Masih Kosong!!",Toast.LENGTH_SHORT).show();
                }else if(etNilaib.getText().toString().isEmpty()){
                    Toast.makeText(MainActivity.this, "Nilai B nya Masih Kosong!!",Toast.LENGTH_SHORT).show();
                }else{
